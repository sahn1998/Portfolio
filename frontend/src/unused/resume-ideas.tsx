...
import "./SeoulResumeComponent.css";
                ...
                <div className="section-card-background section-card-background--introduction">
                    ...
                    <div className="section-photo-label">
                        ...
                        <p className="label-story">
                            Seoul is where my story begins — a city of movement, ambition, and constant reinvention.
                            <br></br>
                            <br></br>
                            Korea taught me discipline, resilience, and the importance of pushing forward. It remains the foundation of who I am, no matter where I go next.
                        </p>
                    </div>
