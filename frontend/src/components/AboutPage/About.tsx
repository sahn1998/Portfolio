    ...
    <div className="about-profile-row">
        <div className="about-profile-image-wrap">
            <div className="about-profile-card">
                <img
                    src={require('../../images/aboutme-page/sunghyunahn.jpg')}
        ...
        <div className="about-profile-text">
            <div className="about-profile-list">
                <p><strong>1.</strong> Data Scientist</p>
                <p>
                    <strong>2.</strong> Seattle University Graduate Student
            ...
            <p className="about-profile-body">
                ...
                My work as an analyst, a research assistant, and a data science intern taught me that curiosity is as essential as any technical skill.
