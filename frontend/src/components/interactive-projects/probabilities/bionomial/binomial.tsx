					...
					<div className="overlay">
                        <div className="sections">
							<div className="content">
								...
								<br></br>
								<div className="main-page-intro">
									<span style={{ color: '#e2cee4ff', fontSize: '20px', marginTop: '20px'}}>
								...
								<div className="main-page-intro">
									...
									<span>
										...
										You test {testSliderValue} cars in a batch <span style={{ color: '#83d0feff' }}>(change the numbers around on the slider!)</span> and calculate the probability of observing exactly 30 defective cars.
										This is denoted as P(data | success rate), which represents the probability of observing the data given the success rate.
										<br></br>
										<br></br>
										<span style={{ color: '#83d0feff' }}>In short, we want to know the likelihood of observing 30 defective Teslas given "p" and "𝑛".</span>
									</span>
								</div>
								<br></br>
								<br></br>
								...
								<div className="main-page-intro">
									...
									<span>
									In most real-world scenarios, we don’t know the exact success rate (p). <span style={{ color: '#83d0feff' }}>Instead, we work backward to estimate the probability of manufacturing a defective car based on the observed data.</span> This involves calculating 
								...
								<div className="main-page-intro">
									...
									<img src={binomialPMF} alt="Example" />
									<br></br>
									<span style={{ color: '#83d0feff', textAlign: 'center', marginTop: '20px'}}>
